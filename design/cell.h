...
private:
    ...
    //Множество ячеек, на которые ссылается данная ячейка. Дублируют информацию из FormulaAST для удобства
    //решено сделать вектором, так как в реализации не требуется добавления и удаления этих элементов из 
    //середины  контейнера, но требуется возврат отсортированных значений.
